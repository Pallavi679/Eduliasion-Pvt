...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio | EduLiasion Olympiads";
        $("#favicon").attr("href","./assests/images/logo-removebg-preview.png");
    }
    else {
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["EMO(EduLiasion Mathematics Olympiods","ESO(EduLiasion Science Olympiods"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
